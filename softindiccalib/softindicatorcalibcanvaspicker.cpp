...
bool SoftIndicatorCalibCanvasPicker::eventFilter( QObject *object, QEvent *event )
{
...
void SoftIndicatorCalibCanvasPicker::select( const QPoint &pos )
{
...
void SoftIndicatorCalibCanvasPicker::moveBy( int dx, int dy )
{
    if ( dx == 0 && dy == 0 )
        return;
...
// Move the selected point
void SoftIndicatorCalibCanvasPicker::move( const QPoint &pos )
{
    if ( !d_selectedCurve )
        return;
...
void SoftIndicatorCalibCanvasPicker::showCursor( bool showIt )
{
    if ( !d_selectedCurve )
        return;
...
void SoftIndicatorCalibCanvasPicker::shiftCurveCursor( bool up )
{
...
void SoftIndicatorCalibCanvasPicker::shiftPointCursor( bool up )
{
    if ( !d_selectedCurve )
        return;
