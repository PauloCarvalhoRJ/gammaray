...
QRectF SVDFactorsSelectionChartCallout::boundingRect() const
{
...
void SVDFactorsSelectionChartCallout::paint(QPainter *painter, const QStyleOptionGraphicsItem *option, QWidget *widget)
{
	Q_UNUSED(option)
	Q_UNUSED(widget)
	QPainterPath path;
...
void SVDFactorsSelectionChartCallout::mousePressEvent(QGraphicsSceneMouseEvent *event)
{
	event->setAccepted(true);
}

void SVDFactorsSelectionChartCallout::mouseMoveEvent(QGraphicsSceneMouseEvent *event)
{
...
void SVDFactorsSelectionChartCallout::setText(const QString &text)
{
	m_text = text;
...
void SVDFactorsSelectionChartCallout::setAnchor(QPointF point)
{
	m_anchor = point;
}

void SVDFactorsSelectionChartCallout::updateGeometry()
{
	prepareGeometryChange();
