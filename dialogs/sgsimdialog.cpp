...
void SGSIMDialog::updateVariogramParameters(VariogramModel *vm)
{
    ...
    par28->_nst_and_nugget->getParameter<GSLibParDouble*>(1)->_value = vm->getNugget(); //nugget effect contribution

    par28->_variogram_structures;
    ...
    for( uint ist = 0; ist < vm->getNst(); ++ist)
    {
        ...
        par28_0->getParameter<GSLibParDouble*>(1)->_value = vm->getCC( ist );
