...
from conan.tools.files import copy, get, rmdir, rm, unzip
...
class DoubleConversionConan(ConanFile):
    ...
    # Conan's workspace.
    exports_sources = "double-conversion-{}.tar.gz".format(version)
    ...
    def source(self):
        ...
        unzip(self, filename=os.path.join(self.source_folder, "..", "double-conversion-{}.tar.gz".format(self.version)), destination=".")
        copy(self, pattern="*", src=os.path.join(self.source_folder, "double-conversion-{}".format(self.version)), dst=".")
