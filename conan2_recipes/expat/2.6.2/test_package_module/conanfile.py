...
# NOTE: this test package tests whether some variables from https://cmake.org/cmake/help/latest/module/FindEXPAT.html
# are properly defined in conan generators, in addition to what the test in /test_package does.
